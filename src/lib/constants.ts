...
export const ERROR_MESSAGES = {
  ...
  NO_FILE_PROVIDED: 'Nenhum arquivo selecionado. Escolha um arquivo para continuar.',
  TRANSCRIPTION_FAILED: 'A transcrição do áudio falhou. Verifique o arquivo e tente novamente.',
  HIGHLIGHTS_FAILED: 'A geração dos highlights falhou. Tente novamente em alguns instantes.',
  INVALID_AUDIO_FILE: 'Formato inválido. Aceitamos: MP3, WAV, M4A, OGG, FLAC, WebM.',
  API_KEY_MISSING: 'Chave da API OpenAI não configurada. Adicione sua chave nas configurações.',
