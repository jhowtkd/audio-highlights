...
export const ERROR_MESSAGES = {
  FILE_TOO_LARGE: 'O arquivo excede o limite de 500MB. Comprima o arquivo ou divida em partes menores.',
  AUDIO_TOO_LONG: 'O arquivo excede o limite de 4 horas. Divida o arquivo em partes menores.',
  NO_FILE_PROVIDED: 'Nenhum arquivo enviado',
  TRANSCRIPTION_FAILED: 'Não foi possível transcrever o arquivo. Verifique o arquivo e tente novamente.',
