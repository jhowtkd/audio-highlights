...
export const ERROR_MESSAGES = {
  ...
  NO_FILE_PROVIDED: 'Nenhum arquivo enviado. Selecione um áudio ou vídeo para começar.',
  TRANSCRIPTION_FAILED: 'Não foi possível transcrever. Verifique se o áudio está claro e tente novamente.',
  HIGHLIGHTS_FAILED: 'A geração de highlights falhou. Verifique sua conexão e tente novamente.',
  INVALID_AUDIO_FILE: 'Formato inválido. Aceitamos: MP3, WAV, M4A, OGG, FLAC, WebM.',
  API_KEY_MISSING: 'Chave da API OpenAI não configurada. Adicione sua chave nas configurações para continuar.',
