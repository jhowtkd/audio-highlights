...
export const ERROR_MESSAGES = {
  FILE_TOO_LARGE: 'Arquivo muito grande (máx. 500MB). Tente comprimir ou dividir.',
  AUDIO_TOO_LONG: 'Áudio muito longo (máx. 4h). Divida em partes menores.',
  NO_FILE_PROVIDED: 'Nenhum arquivo enviado',
  TRANSCRIPTION_FAILED: 'Falha na transcrição. Verifique o arquivo e tente novamente.',
  HIGHLIGHTS_FAILED: 'Não foi possível gerar os highlights. Tente novamente.',
