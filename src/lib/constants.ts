...
export const MAX_ID_LENGTH = 100; // SECURITY: Limit ID length to prevent DoS via memory exhaustion
export const MAX_TEXT_LENGTH = 50000; // SECURITY: Limit text length to prevent DoS via memory exhaustion
export const MAX_WORD_LENGTH = 200; // SECURITY: Limit word length to prevent DoS via memory exhaustion
export const MAX_WORDS_PER_SEGMENT = 10000; // SECURITY: Limit words per segment to prevent DoS via memory exhaustion
