...
export const ERROR_MESSAGES = {
  FILE_TOO_LARGE: 'O arquivo deve ter no máximo 500MB. Tente enviar um arquivo menor.',
  AUDIO_TOO_LONG: 'O áudio deve ter no máximo 4 horas. Tente enviar um arquivo mais curto.',
  ...
  INVALID_AUDIO_FILE: 'Formato não suportado. Use arquivos como MP3, WAV ou MP4.',
