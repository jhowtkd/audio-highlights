    ...
    useEffect(() => {
        ...
        const generateWaveform = async () => {
            ...
            try {
                ...
                // Sample max 100 points per block to avoid blocking main thread on large files
                // Performance: Reduces iteration count from O(totalSamples) to O(samples * maxSamplesPerBlock)
