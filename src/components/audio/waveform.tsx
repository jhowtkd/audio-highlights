    ...
    useEffect(() => {
        ...
        const generateWaveform = async () => {
            ...
            try {
                ...
                // Optimization: Sample the data instead of iterating over every single sample
                // Performance: Reduces loop iterations by ~100x, preventing main thread blocking on large audio files
