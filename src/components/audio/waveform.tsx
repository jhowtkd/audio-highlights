    ...
    useEffect(() => {
        ...
        const generateWaveform = async () => {
            ...
            try {
                ...
                // Performance: Sub-sample to avoid iterating over millions of items on the main thread
                // Sample up to 100 points per block to significantly reduce calculation time
