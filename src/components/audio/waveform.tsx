    ...
    useEffect(() => {
        ...
        const generateWaveform = async () => {
            ...
            try {
                ...
                // Performance: Subsample audio data to avoid iterating over every sample,
                // which would block the main thread for long audio files.
                // We sample up to 100 points per block.
                const sampleSize = 100;
                const stepSize = Math.max(1, Math.floor(blockSize / sampleSize));
