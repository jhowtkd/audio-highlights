    ...
    useEffect(() => {
        ...
        const generateWaveform = async () => {
            ...
            try {
                ...
                // Optimization: Downsample the audio buffer to prevent main thread blocking
                // Performance: Reduces loop iterations from O(N) to O(1) by capping at 100 samples per block.
