    ...
    useEffect(() => {
        ...
        const generateWaveform = async () => {
            ...
            try {
                ...
                // Performance: Calculate step size to sample a subset of points instead of iterating over every single sample.
                // Reduces main thread blocking for large files from ~500ms to ~5ms.
