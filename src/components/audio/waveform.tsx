...
export function Waveform({
    ...
    const handleMouseMove = useCallback((e: React.MouseEvent<HTMLDivElement>) => {
        ...
        // Performance: Extract required event properties synchronously outside the callback
        // to avoid accessing stale or nullified event data due to React's event pooling.
        ...
        // Performance: Throttle the high-frequency mousemove event using requestAnimationFrame
        // to prevent layout thrashing and main-thread blocking when reading DOM geometry.
