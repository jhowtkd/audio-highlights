...
export function Waveform({
    ...
    // Performance: Throttle high-frequency events using requestAnimationFrame to prevent layout
    // thrashing from synchronous getBoundingClientRect() calls and reduce main thread blocking
