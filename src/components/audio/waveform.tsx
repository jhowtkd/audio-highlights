        ...
        const generateWaveform = async () => {
            ...
            try {
                ...
                for (let i = 0; i < samples; i++) {
                    ...
                    // Optimization: Instead of processing every sample (O(N) which blocks main thread for long files),
                    // we stride through the block, sampling a maximum of 100 points per block.
                    // This reduces operations from O(N) to O(1) per block.
