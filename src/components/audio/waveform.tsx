    ...
    useEffect(() => {
        ...
        const generateWaveform = async () => {
            ...
            try {
                ...
                // Performance: Downsample the audio data instead of iterating synchronously over every single sample.
                // This prevents the main UI thread from blocking, reducing computation time significantly for large audio files.
                // E.g. instead of processing 26M samples for a 10 min file, we process ~20k.
