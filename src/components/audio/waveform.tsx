...
// Performance: Memoize Waveform component to prevent unnecessary re-renders when parent's rapidly changing state (currentTime) doesn't affect rendering of heavy canvas and logic
