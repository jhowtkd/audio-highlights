...
export function Waveform({
    ...
    const handleMouseMove = useCallback((e: React.MouseEvent<HTMLDivElement>) => {
        ...
        // Throttle mousemove calculations to screen refresh rate (60fps) to prevent main thread blocking
        // Performance: Significantly reduces layout recalculations and React state updates on rapid mouse movements
