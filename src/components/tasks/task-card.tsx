...
export function TaskCard({ task }: TaskCardProps) {
    ...
    // handleViewResult removed in favor of Link component

    const handleRetranscribe = () => {
        if (!confirm('Retranscrever arquivo? Isso apagará os resultados atuais e consumirá créditos novamente.')) {
            return;
        }
        ...
        <div className={cn(
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {isProcessing && (
                        <div className="mt-3">
                            <div className="flex items-center justify-between text-sm mb-1.5" aria-live="polite" aria-atomic="true">
