                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            Os resultados atuais serão apagados e você gastará créditos novamente para processar este arquivo.
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
                                        <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                        <AlertDialogAction onClick={handleRetranscribe} className="bg-blue-600 hover:bg-blue-700 focus-visible:ring-blue-600">
                                            Retranscrever
                                        </AlertDialogAction>
                                    </AlertDialogFooter>
                                </AlertDialogContent>
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            Tem certeza que deseja excluir o projeto &quot;{task.filename}&quot;? Esta ação não poderá ser desfeita e todos os dados associados serão perdidos.
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
                                        <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                        <AlertDialogAction onClick={() => removeTask(task.id)} className="bg-red-600 hover:bg-red-700 focus-visible:ring-red-600">
                                            Excluir
                                        </AlertDialogAction>
                                    </AlertDialogFooter>
                                </AlertDialogContent>
