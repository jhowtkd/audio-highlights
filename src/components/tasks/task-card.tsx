                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    ...
                                    <AlertDialogFooter>
                                        ...
                                        <AlertDialogAction onClick={handleRetranscribe}>Continuar</AlertDialogAction>
                                    </AlertDialogFooter>
                                </AlertDialogContent>
                            </AlertDialog>
                        )}
                        ...
                        {(task.status === 'completed' || task.status === 'error' || task.status === 'pending') && (
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    ...
                                    <AlertDialogFooter>
                                        <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                        <AlertDialogAction onClick={() => removeTask(task.id)} className="bg-red-600 hover:bg-red-700 text-white focus:ring-red-600">
                                            Excluir
                                        </AlertDialogAction>
                                    </AlertDialogFooter>
                                </AlertDialogContent>
