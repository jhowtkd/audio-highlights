        ...
        {audioFile.duration < 60 && (
          ...
          >
            ...
            <div className="text-sm text-amber-800 dark:text-amber-200">
              <p className="font-medium">Áudio com menos de 1 minuto ({formatDuration(audioFile.duration)})</p>
              <p className="mt-0.5 text-amber-700 dark:text-amber-300">
                Recomendamos áudios mais longos para gerar bons highlights. Você pode continuar, mas o resultado pode ser limitado.
              </p>
            </div>
          </div>
        )}
