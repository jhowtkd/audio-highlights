                ...
                <div className="space-y-3">
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-slate-600 dark:text-slate-400 flex items-center gap-1.5">
                            ...
                            <button
                                type="button"
                                className="group relative flex items-center justify-center rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                                aria-describedby="tooltip-whisper"
                            >
                                <span className="sr-only">Informação sobre custo de transcrição</span>
                    ...
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-slate-600 dark:text-slate-400 flex items-center gap-1.5">
                            ...
                            <button
                                type="button"
                                className="group relative flex items-center justify-center rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                                aria-describedby="tooltip-gpt"
                            >
                                <span className="sr-only">Informação sobre custo de análise AI</span>
                                <Info className="h-3.5 w-3.5 text-slate-400" aria-hidden="true" />
                                <span
                                    id="tooltip-gpt"
                                    role="tooltip"
