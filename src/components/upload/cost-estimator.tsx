                    ...
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-slate-600 dark:text-slate-400 flex items-center gap-1.5">
                            ...
                            <button
                                ...
                                className="group relative cursor-help rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                            >
                                <span className="sr-only">Informações sobre o preço da transcrição</span>
                    ...
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-slate-600 dark:text-slate-400 flex items-center gap-1.5">
                            ...
                            <button
                                ...
                                className="group relative cursor-help rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                            >
                                <span className="sr-only">Informações sobre o preço da análise de IA</span>
                                <Info className="h-3.5 w-3.5 text-slate-400" aria-hidden="true" />
                                <span
                                    id="gpt-tooltip"
                                    role="tooltip"
