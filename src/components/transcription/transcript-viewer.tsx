        ...
        <div className="space-y-2">
          {searchResults.map((result) => (
            <button
              ...
              className="w-full text-left p-3 rounded-lg transition-all duration-200 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border border-blue-200 dark:border-blue-800 hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
