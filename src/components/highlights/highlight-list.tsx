  ...
  if (highlights.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 text-slate-500 text-center">
        <Sparkles className="h-8 w-8 mb-3 text-slate-400" />
        <h3 className="text-lg font-medium text-slate-900 dark:text-slate-100 mb-1">Nenhum highlight ainda</h3>
        <p className="text-sm mt-1 max-w-sm">Ajuste os parâmetros ao lado e clique em &quot;Gerar Highlights&quot; para começar a criar cortes.</p>
      </div>
    );
  }
