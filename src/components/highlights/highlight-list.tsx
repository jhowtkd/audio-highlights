  ...
  if (highlights.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 text-slate-500 text-center">
        <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-full mb-4 text-slate-400">
          <Sparkles className="h-8 w-8" />
        </div>
        <h3 className="text-lg font-medium text-slate-900 dark:text-slate-100">Pronto para criar seus highlights?</h3>
        <p className="text-sm mt-2 max-w-sm">Ajuste as configurações ao lado e clique em &quot;Gerar Highlights&quot; para extrair os melhores momentos do seu áudio.</p>
      </div>
    );
  }
