  ...
  if (highlights.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-slate-500">
        <div className="h-12 w-12 rounded-full bg-indigo-50 dark:bg-indigo-900/30 flex items-center justify-center mb-4">
          <Sparkles className="h-6 w-6 text-indigo-500" />
        </div>
        <h3 className="text-lg font-medium text-slate-900 dark:text-slate-100 mb-1">Nenhum highlight gerado</h3>
        <p className="text-sm text-center max-w-sm">Configure os parâmetros acima e clique em &quot;Gerar Highlights&quot; para começar.</p>
      </div>
    );
  }
