  ...
  if (highlights.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 text-slate-500">
        <p className="font-medium text-slate-900 dark:text-slate-100 text-lg">Pronto para encontrar os melhores momentos</p>
        <p className="text-sm mt-2">Escolha uma plataforma ao lado e clique em &quot;Gerar Highlights&quot;</p>
      </div>
    );
  }
