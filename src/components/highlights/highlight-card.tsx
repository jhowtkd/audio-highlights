          ...
          {highlight.suggestedTitles && highlight.suggestedTitles.length > 0 && (
            <div className="space-y-2">
              <button
                ...
                className="flex items-center gap-1 text-xs text-blue-600 dark:text-blue-400 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded px-1"
              >
