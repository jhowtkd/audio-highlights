...
**Performance (Measured in POC):**
- **Model Load:** ~1.11s (uncached)
- **Search Speed:** ~4-5ms per query (scales linearly, effectively instant for <10k segments)
- **Accuracy:** Correctly identified "money and jobs" -> "The economic impact of automation..." (Score: 0.2562)
