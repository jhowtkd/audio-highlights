...
## 2026-03-05 - Generic API Error Message Improvement

**Copy Type:** Generic API Error Message
**Original:** "Ocorreu um erro inesperado. Tente novamente."
**Changed To:** "Não foi possível completar a ação. Tente novamente em alguns minutos."
**Learning:** "Erro inesperado" is a robotic phrase that is vague and scary for users. The new copy is more human, explains the outcome ("Não foi possível completar a ação"), and provides a realistic retry timeline instead of an immediate command.
**Rule:** Avoid robotic error phrases like "erro inesperado". Use clear, user-friendly language that explains the outcome and gives a realistic timeline for retrying.
