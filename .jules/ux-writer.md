...
## 2026-03-02 - Transcription Error Improvement
...
**Learning:** The 'Erro:' prefix is robotic and alarming. Furthermore, missing actionable steps (like in the second case) or using informal verbs like 'recarregar' without context can confuse users.
**Rule:** In Portuguese user-facing copy, avoid prefixing error messages with the robotic and alarming 'Erro:'. Instead, write friendly, actionable error messages that provide specific next steps for the user (e.g., 'Por favor, recarregue a página.').
