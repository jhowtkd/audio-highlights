...
## 2026-02-18 - Unify Terminology

**Copy Type:** Interface Text & Error Messages
**Original:** "áudio"
**Changed To:** "arquivo"
**Learning:** The application accepts both audio and video formats, making the term "áudio" confusing and inaccurate for users uploading videos.
**Rule:** Always refer to media assets as "arquivo" (file) in user-facing UI text to ensure terminology consistency and a format-agnostic mental model.
