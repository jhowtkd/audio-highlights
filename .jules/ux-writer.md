...
## 2024-07-14 - Remove Robotic Error Prefix
...
**Learning:** Prefixing error messages with "Erro:" creates a robotic and alarming tone. Actionable error messages that provide specific next steps and use a friendlier tone improve user experience and reduce frustration.
**Rule:** Avoid prefixing error messages with the robotic and alarming 'Erro:'. Instead, write friendly, actionable error messages that provide specific next steps for the user.
