...
**Learning:** Prefixing messages with 'Erro:' is robotic and alarming in Portuguese. A friendly, actionable message provides a better experience.
**Rule:** Never prefix error messages with 'Erro:'. Write friendly, actionable error messages that provide specific next steps for the user.
