...
## 2026-05-25 - Generalizing Media Terms

**Copy Type:** Upload and processing actions / status
...
**Learning:** The application accepts video files as well as audio files, and the full pipeline does more than just transcribe. Using terms like "Áudio" and "Transcrição" is restrictive and can confuse users uploading videos.
**Rule:** Unify terminology by using 'Arquivo' (File) for uploads and 'Processamento' (Processing) for workflows and results, rather than restrictive media terms like 'Áudio' or overly specific actions like 'Transcrição'.
