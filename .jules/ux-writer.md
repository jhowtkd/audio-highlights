...
## 2024-05-18 - Replacing Technical Anglicism with Active Verb

**Copy Type:** Subtitle / Description text
**Original:** "Faça upload do seu áudio..."
**Changed To:** "Envie seu áudio..."
**Learning:** In Portuguese user-facing copy, using active verbs (like 'Envie') is more conversational and approachable than passive technical jargon or anglicisms (like 'Faça upload').
**Rule:** Prefer active, common verbs over technical jargon or anglicisms to create a more conversational and approachable tone.
