...
**Learning:** The previous empty state was phrased negatively. As specified in my memory, interface copy for empty states should prioritize actionable next steps and a positive tone rather than negative statements.

**Rule:** For this app, ALWAYS use positive, action-oriented copy for empty states, such as "Pronto para encontrar os melhores momentos" rather than negative statements like "Nenhum highlight gerado ainda".
