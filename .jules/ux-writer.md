...
## 2025-01-25 - Content Format Neutrality

**Copy Type:** Upload instructions and status messages
**Original:** "Arraste seu áudio aqui" / "Enviando áudio..." / "Áudio curto"
**Changed To:** "Arraste seu arquivo aqui" / "Enviando arquivo..." / "Arquivo curto"
**Learning:** The application accepts both audio and video files. Using "áudio" creates a confusing mental model for users who want to upload a video, leading them to think their format isn't supported.
**Rule:** For this app, ALWAYS refer to media assets as 'arquivo' (file) to maintain a format-agnostic mental model, since the application accepts both audio and video formats.
