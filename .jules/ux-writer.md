...
## 2025-02-04 - Empty State Tone Decision

**Copy Type:** Empty state for highlight list

**Original:** "Nenhum highlight gerado ainda"

**Changed To:** "Pronto para encontrar os melhores momentos"

**Learning:** Empty states with negative language like "None" or "No [items]" sound dead-ended and uninspiring. Using positive, action-oriented framing ("Ready to find...") creates a more welcoming and encouraging experience for the user.

**Rule:** For empty states, ALWAYS:
1. Use positive, action-oriented copy rather than negative statements.
2. Avoid phrases like "Nenhum [item]" or "Sem [item]".
3. Frame the empty state as an opportunity or the start of a process.

**Pattern to follow:**
- ❌ "Nenhum [item] gerado ainda" / "No [items] yet"
- ✅ "Pronto para [ação que gera itens]" / "Ready to [action that generates items]"
