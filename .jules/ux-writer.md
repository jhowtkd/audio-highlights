...
## 2024-07-10 - Removed Robotic Error Prefix
...
**Learning:** Using the "Erro:" prefix makes messages sound robotic and alarming to users. Friendly, actionable error messages provide better UX.
**Rule:** In Portuguese user-facing copy, avoid prefixing error messages with the robotic and alarming 'Erro:'. Instead, write friendly, actionable error messages that provide specific next steps.
