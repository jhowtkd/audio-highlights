...
## 2026-03-05 - Active Voice in Processing Error

**Copy Type:** Error state title and description

**Original:**
"Não foi possível processar"
"Tivemos um problema técnico. Por favor, tente novamente."

**Changed To:**
"O processamento falhou"
"Ocorreu um erro ao processar seu arquivo. Tente novamente em instantes."

**Learning:** Using active voice ("O processamento falhou") is more direct than the passive ("Não foi possível processar"). Telling the user exactly what failed ("processar seu arquivo") gives better context than generic terms like "problema técnico". "Em instantes" also sets a better expectation than a plain "tente novamente".

**Rule:** For fallback error messages:
1. Use active voice over passive voice.
2. Tell the user what action failed, if known (e.g., "processar seu arquivo").
3. Set an expectation for the retry action (e.g., "em instantes").
