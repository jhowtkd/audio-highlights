...
## 2026-03-01 - Replace Jargon in Hero Subtitle

**Copy Type:** Main page hero subtitle
**Original:** "Faça upload do seu áudio e deixe a IA identificar os melhores momentos"
**Changed To:** "Envie seu áudio e deixe a IA identificar os melhores momentos"
**Learning:** The phrase "Faça upload" is a technical term that can feel passive. Using "Envie" uses active voice, is more conversational, and focuses on the action the user performs (sending their content) rather than the technical process (uploading). This aligns with the previous learning to avoid technical jargon and use active verbs.
**Rule:** Always prefer active verbs like "Envie" over passive technical jargon like "Faça upload" in user-facing copy to create a more conversational and approachable tone.
