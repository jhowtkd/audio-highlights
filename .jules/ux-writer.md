...
## 2024-05-24 - Action-Oriented Confirmation Dialogs
...
**Learning:** Robotic filler phrases like "Tem certeza que deseja" slow down the user and make the interface feel less professional. Using direct, action-oriented questions ("Retranscrever arquivo?") clarifies the intent immediately. Also, using "consumir" instead of "gastar" for credits sounds more professional.

**Rule:** For this app, ALWAYS:
1. Avoid "Tem certeza que deseja" or "Deseja realmente".
2. Start confirmation questions with the specific action verb (e.g., "Retranscrever arquivo?", "Excluir projeto?").
3. Use professional terms like "consumir créditos" instead of casual terms like "gastar créditos".

**Pattern to follow:**
- ❌ "Tem certeza que deseja [ação]?"
- ✅ "[Ação]?"
