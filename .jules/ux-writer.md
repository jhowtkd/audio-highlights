...
## 2024-07-29 - Consistent Gender Agreement for "Projeto"
...
**Learning:** The UI uses "Projetos" (masculine) instead of "Tarefas" (feminine) to avoid technical jargon ("tasks"). Therefore, adjectives referring to completed items must use masculine agreements.

**Rule:** For this app, ALWAYS use masculine gender agreements (e.g., 'Concluídos', not 'Concluídas') when referring to items, to match the content-first term 'Projeto'. Avoid the internal jargon 'task' or 'tarefa'.
