...
## 2026-03-01 - Terminology Unification (Project vs Audio)

**Copy Type:** Dialog Title & Dropzone Labels
**Original:** "Adicionar novo áudio" / "Enviando áudio..." / "Arraste seu áudio aqui"
**Changed To:** "Criar novo projeto" / "Enviando arquivo..." / "Arraste seu arquivo aqui"
**Learning:** The empty state button says "Criar novo projeto", but opening it revealed a dialog titled "Adicionar novo áudio". This terminology mismatch creates cognitive friction. Also, since the app accepts video files, referring exclusively to "áudio" is technically inaccurate.
**Rule:** Ensure consistent terminology between actions and their resulting views (e.g., Button -> Dialog Title). Use format-agnostic terms like "arquivo" (file) when the app handles multiple media types to prevent user confusion.
