...
## 2024-05-18 - Positive Empty State Copy

**Copy Type:** Empty state text

**Original:** "Nenhum highlight gerado ainda"

**Changed To:** "Pronto para encontrar os melhores momentos"

**Learning:** Negative empty state copy like "Nenhum highlight gerado ainda" focuses on what the user hasn't done yet, which can feel unhelpful or slightly negative. Shifting the tone to focus on the value the user is about to get ("Pronto para encontrar os melhores momentos") makes the empty state feel welcoming and action-oriented.

**Rule:** For empty states, ALWAYS:
1. Focus on the value the user will get.
2. Use a positive, action-oriented tone rather than a negative one.
3. Combine the positive header with helper text that guides the user to the next action.
