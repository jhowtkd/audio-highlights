...
**Learning:** Prefixing error messages with "Erro:" is robotic and alarming. Providing a clear next step ("Por favor, recarregue a página.") makes the message actionable. Both error messages now have consistent copy.
**Rule:** Avoid the prefix "Erro:" in Portuguese user-facing copy. Write friendly, actionable error messages with specific next steps.
