...
## 2025-05-24 - Empty State Tone Decision
...
**Learning:** Users respond better to positive, action-oriented empty states than negative statements. The original copy was a dead-end phrase ("Nenhum..."). The new copy is friendly and encourages action.
**Rule:** For empty states, ALWAYS:
1. Use positive, action-oriented copy.
2. Avoid negative statements (e.g., "Nenhum...", "Não há...").
3. Provide clear next steps or guidance on how to populate the state.
