...
## 2026-04-16 - Contextual Confirmation Dialogs
...
**Changed To:** `Retranscrever '${task.filename}'? Os resultados atuais serão apagados e você gastará créditos novamente.`

**Learning:** Generic confirmation messages that ask "Are you sure..." and refer to "this file" are ambiguous, especially when dealing with destructive actions like overwriting a transcript and spending credits. By injecting the specific filename into the dialog and clearly stating the action, the user knows exactly what they are doing and what the consequences are.

**Rule:** For confirmation dialogs (`window.confirm()`), ALWAYS avoid vague phrasing like "Are you sure you want to...". Start directly with the specific action and the specific item name (e.g., using string interpolation), followed immediately by clear, direct consequences.
