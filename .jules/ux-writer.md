...
## 2026-03-02 - Remove Robotic Error Prefix and Technical Jargon

**Copy Type:** Error Message and Subtitle
**Original:** "Erro: Transcrição não encontrada. Tente recarregar." and "Faça upload"
**Changed To:** "Transcrição não encontrada. Por favor, recarregue a página." and "Envie"
**Learning:** Prefixing error messages with "Erro:" is robotic and alarming to users. "Faça upload" is passive technical jargon. Using friendly, actionable error messages and active verbs like "Envie" improves clarity and user confidence.
**Rule:** Do not prefix error messages with "Erro:". Prefer active verbs like "Envie" over technical jargon like "Faça upload".
